...
$config['authentication'] = function () {
    ...
    //     $session->start();
    // }
    // if (!$app['auth']->check() || !$app['auth']->user()->is_admin){  у препода работает, у меня нет. Тут проверка на авторизованность и админа
    //     header('HTTP/1.0 403 Forbidden'); exit();  у меня неверный запрос, как будто не авторизованный я
    // }
    return true;
};
