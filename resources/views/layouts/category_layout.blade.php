                        ...
                        <div class="sidebar">
                            <div class="widget">
                                ...
                                <div class="link-widget">
                                    <ul>
                                        <li><a href="{{ route('tags.single', ['slug' => 'marketing']) }}">Marketing </a></li>
                                        <li><a href="{{ route('tags.single', ['slug' => 'seo']) }}">SEO Service </a></li>
                                        <li><a href="{{ route('tags.single', ['slug' => 'digital-agency']) }}">Digital Agency</a></li>
                                        <li><a href="{{ route('tags.single', ['slug' => 'make-money']) }}">Make Money</a></li>
                                        <li><a href="{{ route('tags.single', ['slug' => 'blogging']) }}">Blogging</a></li>
                                        <li><a href="{{ route('tags.single', ['slug' => 'entertaintment']) }}">Entertaintment</a></li>
                                        <li><a href="{{ route('tags.single', ['slug' => 'video-tuts']) }}">Video Tuts</a></li>
                                    </ul>
                                </div><!-- end link-widget -->
                            </div><!-- end widget -->
                        </div><!-- end sidebar -->
                        ...
                        <div class="widget">
                            ...
                            <div class="blog-list-widget">
                                <div class="list-group">
                                    ...
                                    <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="/assets/front/pload/small_05.jpg" alt="" class="img-fluid float-left">
